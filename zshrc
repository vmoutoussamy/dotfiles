...
case $_myos in
  Linux)
    ...
    alias startMiniSles154='sudo virsh start Minimal-SLES15.4 && sh ~/dotfiles/waitforssh.sh sshMiniSles154'
    alias startMiniLeap154='sudo virsh start Minimal-Leap15.4 && sh ~/dotfiles/waitforssh.sh sshMiniLeap154'
    alias startMiniFedora36='sudo virsh start Minimal-Fedora36 && sh ~/dotfiles/waitforssh.sh sshMiniFedora36'
  ;;
   Darwin)
